...
function Auto4() {
    return (
        <div className='deny'>
        <div className='don'>
          <div className='hyi'>Books & Stationary</div>
...
<div className='dfrt'>Toy Cars,Trains & Bikes</div>
...
<div className='middle'>
<div className='dfrt'>Key Chains</div>
...
<div className='middle'>
<div className='dfrt'>Card Holder</div>
...
<div className='middle'>
<div className='dfrt'>Soft Toys</div>
...
<div className='middle'>
<div className='dfrt'>Puzzles</div>
...
<div className='middle'>
<div className='dfrt'>Erasers</div>
